...
def eskaera_2():
    ...
    # HTTP / 1.1
    # Host: egela.ehu.eus
    # Cookie: MoodleSessionegela = ntmjfh171g0vnlnsva35dl3eq8bsk2no
    # Content - Type: application / x - www - form - urlencoded
    # Content - Length: 78

    # logintoken = qeZSi44rV0gW70R7x0ykVjTPMHLJ3nsf & username = 916776 & password = IK13er01_
    goiburuak = {'Host': 'egela.ehu.eus',
                 'Cookie': cookie,
                 'Content-Type': 'application/x-www-form-urlencoded'}
